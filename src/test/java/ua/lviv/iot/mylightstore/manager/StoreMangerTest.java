...
public class StoreMangerTest {
    ...
    private static final Item CELLING = new Item("Test1", "TestManufacturerCelling", 10.4, 3, Category.CEILING);
    private static final Item TABLE = new Item("Test2", "TestManufacturerTable", 4.3, 5, Category.TABLE);
    private static final Item FLOOR = new Item("Test3", "TestManufacturerFloor", 6.2, 2.4, Category.FLOOR);
    private static final Lamp LAMP = new Lamp("Test4", "TestManufacturerLamp", 9.1, 10, "red");
    private static final Nightlight NIGHTLIGHT = new Nightlight("Test5", "TestManufacturerNightlight", 100.123, 220, 2.2, 1.2, 5.78);
    private static final Chandelier CHANDELIER = new Chandelier("Test6", "TestManufacturerChandelier", 120.23, 280, "plastic");

    private StoreManager storeManager;

    @BeforeEach
    void setup() {
        storeManager = new StoreManager(new Store(List.of(CELLING, TABLE, FLOOR, LAMP, NIGHTLIGHT, CHANDELIER)));
    }
    ...
    void findItemsByCategoryAndSortAscByPriceTest() {
        ...
        //when
        List<Item> receivedItems = storeManager.findItemsByCategoryAndSortByPrice(requiredCategory, SortDirection.ASC);
    ...
    void findItemsByCategoryAndSortDescByPriceTest() {
        ...
        //when
        List<Item> receivedItems = storeManager.findItemsByCategoryAndSortByPrice(requiredCategory, SortDirection.DESC);
    ...
    void findItemsByCategoryAndSortAscByManufacturerTest() {
        ...
        //when
        List<Item> receivedItems = storeManager.findItemsByCategoryAndSortByManufacturer(requiredCategory, SortDirection.ASC);
    ...
    void findItemsByCategoryAndSortDescByManufacturerTest() {
        ...
        //when
        List<Item> receivedItems = storeManager.findItemsByCategoryAndSortByManufacturer(requiredCategory, SortDirection.DESC);
